...
%% limitations
% small sample size
% choice of 3D modeling software
% what to compare: digital versus hand versus tangible terrain modeling
...
%
%Physically manifesting topographic data coupled with simulated water flow enables users to cognitively grasp the flow of water. 
%
